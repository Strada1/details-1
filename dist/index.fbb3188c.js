...
(0, _view.ELEMENT).formDate.addEventListener("submit", (event)=>handlerCheckDate(event));
function handlerCheckDate(event) {
    event.preventDefault();
    const currentTime = new Date();
    const timeWeIntresting = (0, _view.ELEMENT).fromDate.value;
    if (!timeWeIntresting) return alert("Enter date, please!");
    (0, _view.ELEMENT).textInform.classList.add("active");
    (0, _view.ELEMENT).dateCountDown.classList.add("active");
    (0, _view.ELEMENT).btnStart.setAttribute("disabled", "disabled");
    if (currentTime > new Date(timeWeIntresting)) (0, _view.ELEMENT).textInform.textContent = "From this date has passed";
    else (0, _view.ELEMENT).textInform.textContent = "From this date to the future date";
    let timerId = setInterval(getCurrentTime, 1000, timeWeIntresting);
    setTimeout(()=>{
        (0, _view.ELEMENT).btnStart.removeAttribute("disabled", "disabled");
        (0, _view.ELEMENT).dateCountDown.classList.remove("active");
        (0, _view.ELEMENT).dateCountDown.textContent = "";
        (0, _view.ELEMENT).textInform.classList.remove("active");
        (0, _view.ELEMENT).fromDate.value = "";
        clearInterval(timerId);
    }, 12000);
}
function getCurrentTime(timeWeIntresting) {
    const differentDate = (0, _dateFns.intervalToDuration)({
        start: new Date(timeWeIntresting),
        end: new Date()
    });
    const myDifferentDay = (0, _dateFns.formatDuration)(differentDate);
    (0, _view.ELEMENT).dateCountDown.textContent = myDifferentDay;
}
...
},{"../compareAsc/index.js":"h01l4","../add/index.js":"h7zb2","../differenceInDays/index.js":"1mpAo","../differenceInHours/index.js":"9Vac7","../differenceInMinutes/index.js":"4Qv17","../differenceInMonths/index.js":"8lj6Z","../differenceInSeconds/index.js":"5uZgU","../differenceInYears/index.js":"2tncr","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2GA9o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3Unyy","bDbGG"], "bDbGG", "parcelRequirea83d")
