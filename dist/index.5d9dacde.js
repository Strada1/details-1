...
async function scrollHandler() {
    ...
    if (isScrolledToTop) {
        ...
        const messagesHistory = await (0, _requestsJs.getMessages)((0, _urlJs.getUrl)((0, _urlJs.URL_DIRECTORY).MESSAGES), (0, _authorizationJs.getAuthorizationToken)((0, _authorizationJs.authorizationToken)));
        const messagesHistoryChunk = messagesHistory.slice(arrayItemFrom, arrayItemTo);
        const step = 20;
        (0, _messageJs.renderMessagesHistory)(messagesHistoryChunk, index = 0, userInfo.email);
        arrayItemFrom += step;
        arrayItemTo += step;
        console.log(messagesHistoryChunk.length);
        if (messagesHistoryChunk.length === 0) alert(ALL_MESSAGES_LOAD);
    }
}
...
async function onAppStart() {
    ...
    userInfo = await (0, _requestsJs.getUserInfo)((0, _urlJs.getUrl)((0, _urlJs.URL_DIRECTORY).USER_INFO), (0, _authorizationJs.getAuthorizationToken)((0, _authorizationJs.authorizationToken)));
...
},{"./ui/elements.js":"kdHRQ","./ui/popup.js":"eRZb9","./server/requests.js":"bn0mI","./server/url.js":"dEatQ","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./authorization.js":"iH89i","./ui/message.js":"eNqTc","./ui/getScrollPosition.js":"iqKj9"}],"kdHRQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./elements.js":"kdHRQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gzp3I","1Z4Rq"], "1Z4Rq", "parcelRequire938d")
