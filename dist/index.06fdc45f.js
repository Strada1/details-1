...
})({"740wf":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9a03a87006fdc45f";
"use strict";
...
function showForecast(city) {
    ...
    (0, _storageJs.setLocal)(city);
    (0, _loadForecastJs.loadWeather)(url);
    (0, _loadForecastJs.loadForecast)(forecastUrl);
    (0, _elementsJs.ELEMENTS).cityInput.value = "";
}
(0, _elementsJs.ELEMENTS).citySearch.addEventListener("submit", (event)=>{
...
(0, _vueJs.render)();
(0, _elementsJs.ELEMENTS).buttonFavorite.addEventListener("click", addFavoriteLocation);

},{"./elements.js":"fnwur","./storage.js":"dtUD0","./vue.js":"6L28D","./load-forecast.js":"ahJm7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fnwur":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dtUD0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6L28D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "addFavoriteHTML", ()=>addFavoriteHTML);
parcelHelpers.export(exports, "setNowHTML", ()=>setNowHTML);
parcelHelpers.export(exports, "setDetailHTML", ()=>setDetailHTML);
...
function setNowHTML(degrees, icon, forecastCity) {
    ...
    (0, _elementsJs.ELEMENTS).forecastCity.textContent = forecastCity;
    (0, _elementsJs.ELEMENTS).forecastIcon.removeAttribute("src");
    (0, _elementsJs.ELEMENTS).forecastIcon.removeAttribute("width");
    (0, _elementsJs.ELEMENTS).forecastIcon.removeAttribute("height");
    (0, _elementsJs.ELEMENTS).forecastIcon.setAttribute("src", `http://openweathermap.org/img/wn/${icon}@2x.png`);
}
function setDetailHTML(sunriseTime, sunsetTime, degrees, degreesFeelsLike, detailsWeather, forecastCity) {
    (0, _elementsJs.ELEMENTS).detailsSunrise.textContent = sunriseTime;
    (0, _elementsJs.ELEMENTS).detailsSunset.textContent = sunsetTime;
    (0, _elementsJs.ELEMENTS).detailsTemperature.textContent = degrees;
    (0, _elementsJs.ELEMENTS).detailsFeelsLike.textContent = degreesFeelsLike;
    (0, _elementsJs.ELEMENTS).detailsWeather.textContent = detailsWeather;
    (0, _elementsJs.ELEMENTS).detailsCity.textContent = forecastCity;
}
(0, _elementsJs.ELEMENTS).tabs.forEach((tab, index)=>{
    tab.addEventListener("click", ()=>{
        (0, _elementsJs.ELEMENTS).tabs.forEach((item)=>item.classList.remove("active"));
        (0, _elementsJs.ELEMENTS).forecastScreen.forEach((item)=>item.classList.remove("forecast-start"));
        tab.classList.add("active");
        (0, _elementsJs.ELEMENTS).forecastScreen[index].classList.add("forecast-start");
    });
});

},{"./index.js":"1PUd3","./elements.js":"fnwur","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ahJm7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function loadWeather(url) {
    try {
        ...
        if (response.status === 400 || response.status === 404) throw new ValidationError("отсутствует название города");
        const FORECAST = {
        ...
        (0, _vueJs.setDetailHTML)(sunriseTime, sunsetTime, FORECAST.degrees, FORECAST.degreesFeelsLike, FORECAST.detailsWeather, FORECAST.forecastCity);
    } catch (err) {
        if (err instanceof ValidationError) alert("Данные введены некорректно:" + err.message);
        else alert(err);
    }
}
async function loadForecast(forecastUrl) {
    try {
        let response = await fetch(forecastUrl);
        let json = await response.json();
        const newForecast = json.list.map((item)=>{
            return [
                (0, _dateFns.format)(new Date(item.dt_txt), "d"),
                (0, _dateFns.format)(new Date(item.dt_txt), "MMM"),
                (0, _dateFns.format)(new Date(item.dt_txt), "HH:mm"),
        ...
        document.querySelector(".text-locations.details").textContent = json.city.name;
        let j = 0;
        for (let elem of (0, _elementsJs.DATA)){
            let i = 0;
            for (let item of elem){
                if (j === (0, _elementsJs.DATA).length - 1) item.setAttribute("src", `http://openweathermap.org/img/wn/${newForecast[i][j]}@2x.png`);
                else item.textContent = newForecast[i][j];
                ++i;
            }
            j++;
        }
...
},{"./setTime.js":"d3e23","./vue.js":"6L28D","./elements.js":"fnwur","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d3e23":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["740wf","1PUd3"], "1PUd3", "parcelRequire94c2")

//# sourceMappingURL=index.06fdc45f.js.map
