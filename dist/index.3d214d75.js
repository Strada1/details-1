...
function dateDistance() {
    ...
    const currentDate = (0, _dateFns.parseISO)(ELEMENTS.input.value);
    const duration = (0, _dateFns.intervalToDuration)({
        start: new Date(),
        end: currentDate
    });
    const totalTime = currentDate - new Date();
    const days = Math.floor(totalTime / 86400000) - 365 * duration.years;
    if (totalTime >= 0) {
        addTimer(ELEMENTS.years, duration.years);
        addTimer(ELEMENTS.days, days);
        addTimer(ELEMENTS.hours, duration.seconds);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire95a1")
