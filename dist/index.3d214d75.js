...
var _constJs = require("./src/js/const/const.js");
var _moreJs = require("./src/js/more.js");
var _localStorageJs = require("./src/js/localStorage.js");
var _fetchJs = require("./src/js/fetch.js");
var _renderNowJs = require("./src/js/renderNow.js");
var _renderDetailsJs = require("./src/js/renderDetails.js");
var _renderForecastJs = require("./src/js/renderForecast.js");
document.addEventListener("DOMContentLoaded", ()=>{
    const currentCity = (0, _localStorageJs.getCurrentCity)();
    if (currentCity) {
        const city = (0, _fetchJs.getData)(currentCity);
        (0, _renderNowJs.renderNow)(city);
        (0, _moreJs.render)();
    } else {
        const city1 = (0, _fetchJs.getData)((0, _constJs.favoriteCity).textContent);
        (0, _renderNowJs.renderNow)(city1);
    }
});
(0, _constJs.form).addEventListener("submit", (evt)=>{
    (0, _moreJs.submit)(evt);
});
(0, _constJs.searchButton).addEventListener("submit", (evt)=>{
    (0, _moreJs.submit)(evt);
});
(0, _constJs.favoriteButton).addEventListener("click", ()=>{
    (0, _moreJs.createCityItem)((0, _constJs.favoriteCity).textContent);
    const deleteButton = (0, _constJs.favoirtesCities).querySelector(".delete");
    const cities = (0, _constJs.favoirtesCities).querySelectorAll(".add__city");
    (0, _moreJs.addToFavorite)((0, _constJs.favoriteCity).textContent, (0, _constJs.list));
    (0, _moreJs.showDetails)(cities);
    (0, _moreJs.deleteFavorite)(deleteButton, (0, _constJs.favoriteCity).textContent);
});
(0, _constJs.navNow).addEventListener("click", ()=>{
    const cityName = (0, _moreJs.getCurrentCityName)((0, _constJs.headerDetails));
    (0, _renderNowJs.renderNow)(cityName);
});
(0, _constJs.navDetail).addEventListener("click", ()=>{
    const cityName = (0, _moreJs.getCurrentCityName)((0, _constJs.favoriteCity));
    (0, _renderDetailsJs.renderDetails)(cityName);
});
(0, _constJs.navForecast).addEventListener("click", ()=>{
    const currentCity = (0, _localStorageJs.getCurrentCity)();
    const name = (0, _fetchJs.getDataForecast)(currentCity);
    (0, _renderForecastJs.renderForecast)(name);
});

},{"./src/js/const/const.js":"6OIJb","./src/js/more.js":"9rcBT","./src/js/localStorage.js":"45bAM","./src/js/fetch.js":"3MHo1","./src/js/renderNow.js":"1vjOi","./src/js/renderDetails.js":"dhNkb","./src/js/renderForecast.js":"7o9nm"}],"6OIJb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inputSearch", ()=>inputSearch);
parcelHelpers.export(exports, "form", ()=>form);
parcelHelpers.export(exports, "temperature", ()=>temperature);
parcelHelpers.export(exports, "img", ()=>img);
parcelHelpers.export(exports, "favoriteCity", ()=>favoriteCity);
parcelHelpers.export(exports, "favoriteButton", ()=>favoriteButton);
parcelHelpers.export(exports, "favoirtesCities", ()=>favoirtesCities);
parcelHelpers.export(exports, "searchButton", ()=>searchButton);
parcelHelpers.export(exports, "list", ()=>list);
parcelHelpers.export(exports, "contentWeather", ()=>contentWeather);
parcelHelpers.export(exports, "contentDetails", ()=>contentDetails);
parcelHelpers.export(exports, "contentForecast", ()=>contentForecast);
parcelHelpers.export(exports, "headerDetails", ()=>headerDetails);
parcelHelpers.export(exports, "listDetails", ()=>listDetails);
parcelHelpers.export(exports, "temperatureDetail", ()=>temperatureDetail);
parcelHelpers.export(exports, "feelsLikeDetail", ()=>feelsLikeDetail);
parcelHelpers.export(exports, "weatherDetail", ()=>weatherDetail);
parcelHelpers.export(exports, "sunriseDetail", ()=>sunriseDetail);
parcelHelpers.export(exports, "sunsetDetail", ()=>sunsetDetail);
parcelHelpers.export(exports, "navDetail", ()=>navDetail);
parcelHelpers.export(exports, "navNow", ()=>navNow);
parcelHelpers.export(exports, "navForecast", ()=>navForecast);
parcelHelpers.export(exports, "contentNow", ()=>contentNow);
...
},{}],"9rcBT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "renderNow", ()=>(0, _renderNowJs.renderNow));
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "createCityItem", ()=>createCityItem);
parcelHelpers.export(exports, "renderDetails", ()=>(0, _renderDetailsJs.renderDetails));
...
function render() {
    ...
    if (favoriteCityList) favoriteCityList.forEach((favorite)=>{
        createCityItem(favorite.name);
        const deleteButton = (0, _constJs.favoirtesCities).querySelector(".delete");
        const cities = (0, _constJs.favoirtesCities).querySelectorAll(".add__city");
        showDetails(cities);
        deleteFavorite(deleteButton, (0, _constJs.favoriteCity).textContent);
    });
}
...
parcelHelpers.export(exports, "addCurrentCity", ()=>addCurrentCity);
...
function deleteCity(name) {
    for(let key in localStorage){
        ...
        if (obj.name === name) localStorage.removeItem(key);
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1vjOi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderNow", ()=>renderNow);
var _constJs = require("./const/const.js");
var _moreJs = require("./more.js");
function renderNow(data) {
    if (!(0, _constJs.navNow).classList.contains("active")) {
        (0, _moreJs.addClassHide)();
        (0, _constJs.contentWeather).querySelector(".main_weather__city-now").classList.remove("hide");
        (0, _moreJs.removeClassActive)();
        (0, _constJs.navNow).classList.add("active");
    }
    return data.then((obj)=>{
        const temper = obj.main.temp;
        const icon = obj.weather[0].icon;
        const name = obj.name;
        (0, _constJs.temperature).textContent = temper + "\xb0";
        (0, _constJs.img).src = `http://openweathermap.org/img/wn/${icon}@2x.png`;
        (0, _constJs.favoriteCity).textContent = name;
    });
}

},{"./const/const.js":"6OIJb","./more.js":"9rcBT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhNkb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderDetails(cityName) {
    (0, _moreJs.addClassHide)();
    (0, _constJs.contentDetails).classList.remove("hide");
    (0, _moreJs.removeClassActive)();
    (0, _constJs.navDetail).classList.add("active");
    return cityName.then((data)=>{
        ...
        (0, _constJs.headerDetails).textContent = name;
        (0, _constJs.temperatureDetail).textContent = `Temperature: ${temperature}°`;
        (0, _constJs.feelsLikeDetail).textContent = `Feels like: ${feelsLike}°`;
        (0, _constJs.weatherDetail).textContent = `Weather: ${weather}`;
        (0, _constJs.sunriseDetail).textContent = `Sunrise: ${(0, _dateJs.calcTimeSun)(sunrise)}`;
        (0, _constJs.sunsetDetail).textContent = `Sunset: ${(0, _dateJs.calcTimeSun)(sunset)}`;
    });
}

},{"./const/const.js":"6OIJb","./date.js":"HBdq1","./more.js":"9rcBT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"HBdq1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "calcTime", ()=>calcTime);
parcelHelpers.export(exports, "getConvertDate", ()=>getConvertDate);
parcelHelpers.export(exports, "calcTimeSun", ()=>calcTimeSun);
var _dateFns = require("date-fns");
function calcTime(time) {
    return (0, _dateFns.format)(new Date(time * 1000), "HH:MM");
}
function getConvertDate(time) {
    return (0, _dateFns.format)(new Date(time * 1000), "dd MMMM");
}
...
function createForecastList(element, data) {
    return element.insertAdjacentHTML("beforeend", `<li class="forecast_item">
					<div class="forecast_date">
						<p class="forecast_date__day">${(0, _dateJs.getConvertDate)(data.dt)}</p>
						<p class="forecast_date__time">${(0, _dateJs.calcTime)(data.dt)}</p>
					</div>
...
function renderForecast(cityName) {
    (0, _moreJs.addClassHide)();
    (0, _constJs.contentWeather).querySelector(".main_weather__city-forecast").classList.remove("hide");
    (0, _moreJs.removeClassActive)();
    (0, _constJs.navForecast).classList.add("active");
    while((0, _constJs.contentForecast).querySelector(".forecast_list").firstChild)(0, _constJs.contentForecast).querySelector(".forecast_list").firstChild.remove();
    return cityName.then((data)=>{
        const name = data.city.name;
        const forecastList = (0, _constJs.contentForecast).querySelector(".forecast_list");
        (0, _constJs.contentForecast).querySelector(".forecast__header-name").textContent = name;
        addDataToList(forecastList, data);
    });
}

},{"./const/const.js":"6OIJb","./date.js":"HBdq1","./more.js":"9rcBT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequirebbde")
