...
(0, _valueJs.ELEMENTS).BODY.onload = function() {
    if (localStorage.getItem("cities")) city = new Set(JSON.parse(localStorage.getItem("cities")));
...
function getCurrentCity() {
    let url = `${(0, _valueJs.serverUrl)}?q=${document.cookie}&appid=${(0, _valueJs.apiKey)}&units=metric`;
    checkUrl(url);
...
function renderLocation(cities, index) {
    ...
    let newIndex = renderLocation(cities, index - 1) + 1;
    let city = cities[newIndex];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4gG1a"}],"lnm6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
