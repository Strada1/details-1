...
var _getTime = require("./modules/getTime");
var _checkToken = require("./modules/checkToken");
var _getToken = require("./modules/getToken");
var _addHistory = require("./modules/addHistory");
const chat = document.querySelector("#chat");
const sentMessage = document.querySelector("#sent_message");
const message = document.querySelector("#message");
const socket = new WebSocket(`wss://edu.strada.one/websockets?${(0, _getToken.getToken)()}`);
...
socket.onmessage = function(event) {
    ...
    if (messageWS.user.email === "vladvladilin@mail.ru") temp.querySelector("div").classList.add("me");
    else temp.querySelector("div").classList.add("he");
    temp.querySelector("p").textContent = `${name}:${text}`;
    temp.querySelector("span").textContent = (0, _getTime.getTime)(date);
...
function resize() {
    ...
    if (chat.scrollHeight >= 17562) return false;
    else if (scrolled === 0) setTimeout(()=>{
        (0, _addHistory.addHistory)();
        chat.scrollTop += 1200;
    }, 500);
    console.log(chat.scrollHeight);
}
(0, _checkToken.checkToken)();
(0, _addHistory.addHistory)();
chat.scrollTop += 9999999999999;
chat.addEventListener("scroll", resize);

},{"./modules/getToken":"lNNYu","./modules/checkToken":"4PrRw","./modules/getTime":"f5s2G","./modules/addHistory":"9tT1I"}],"lNNYu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getToken", ()=>getToken);
function getToken() {
    const nameAndToken = document.cookie.split("=");
    if (nameAndToken[0] === "token") return nameAndToken[1];
    else return false;
}
...
},{"./getToken":"lNNYu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./getHistory":"9YFIC"}],"9YFIC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getHistory", ()=>getHistory);
var _fetch = require("./fetch");
async function getHistory() {
    const messages = await new (0, _fetch.Fetch)("https://edu.strada.one/api/messages/", "GET").then((response)=>response.ok ? response.json() : Promise.reject(response)).then((result)=>result.messages).catch(()=>{
        alert("Не удалось соединиться с сервером!");
    });
    localStorage.setItem("messages", JSON.stringify(messages));
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetch":"5znah"}],"5znah":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Fetch {
    constructor(url, method, ...body){
        ...
        if (method === "GET") return fetch(this.url, {
            method: this.method,
            headers: {
                "Content-Type": "application/json; charset=utf-8",
                Authorization: "Bearer " + (0, _getToken.getToken)()
            }
        });
        else return fetch(this.url, {
            method: this.method,
            headers: {
                "Content-Type": "application/json; charset=utf-8",
                Authorization: "Bearer " + (0, _getToken.getToken)()
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./getToken":"lNNYu"}],"f5s2G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTime", ()=>getTime);
var _dateFns = require("date-fns");
function getTime(date) {
    const hours = (0, _dateFns.getHours)(new Date(date));
    const minutes = (0, _dateFns.getMinutes)(new Date(date));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k3IR8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9tT1I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addHistory", ()=>addHistory);
var _getTime = require("./getTime");
const message = document.querySelector("#message");
let minLength = 0;
let maxLength = 20;
function addHistory() {
    ...
    if (maxLength === messages.length) {
        ...
        for(let i = minLength; i < maxLength; i++){
            ...
            let text1 = messages[i].text;
            let date = messages[i].createdAt;
            if (messages[i].user.email === "vladvladilin@mail.ru") temp.querySelector("div").classList.add("me");
            else temp.querySelector("div").classList.add("he");
            temp.querySelector("p").textContent = `${name}:${text1}`;
            temp.querySelector("span").textContent = (0, _getTime.getTime)(date);
            chat.prepend(temp);
        }
        minLength += 20;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./getTime":"f5s2G"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire25d8")
