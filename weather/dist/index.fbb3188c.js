...
(0, _renderJs.initialRender)();
window.addEventListener("load", ()=>{
    location.href = "#now";
});

},{"./render.js":"9k0mC"}],"9k0mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderNowBlock", ()=>renderNowBlock);
parcelHelpers.export(exports, "initialRender", ()=>initialRender);
parcelHelpers.export(exports, "setElement", ()=>setElement);
...
var _addedLocationsJs = require("./added-locations.js");
const STORE = {
    currentLocationName: ""
};
...
const onTabClick = (e)=>{
    ...
    if (!currentLink.classList.contains(NAVIGATION_ACTIVE_LINK_CLASS_NAME)) {
        for (let link of navigationElement.children)link.classList.remove(NAVIGATION_ACTIVE_LINK_CLASS_NAME);
...
const onLocationLinkClick = (locationName)=>{
    (0, _getDataJs.getData)((0, _getDataJs.SERVICE).WEATHER, onSuccessGetData, (0, _errorJs.showError), locationName);
    (0, _getDataJs.getData)((0, _getDataJs.SERVICE).FORECAST, (0, _forecastJs.onSuccessGetForecast), (0, _errorJs.showError), locationName);
};
const setElement = ({ parentNode , selector , textContent =null , attributes ={} , dataset ={}  })=>{
    ...
    if (textContent !== null) elementNode.textContent = textContent;
    if (attributes) for (let attributeName of Object.keys(attributes))elementNode[attributeName] = attributes[attributeName];
    if (dataset) for (let dataName of Object.keys(dataset))elementNode.dataset[dataName] = dataset[dataName];
    return elementNode;
};
// Хэндлер нажатия кнопки удаления локации из списка добавленных локаций
const onLocationDeleteClick = (locationName)=>{
    (0, _addedLocationsJs.deleteLocation)(locationName);
    renderLocations();
    ...
    if (nowBlockTitle === locationName) removeActiveClassFromAddButton(addButtonElement);
};
...
const onLocationsListClick = (e)=>{
    ...
    if (clickedElement.classList.contains("weather__locations-item-delete")) {
        const locationName1 = clickedElement.dataset.name;
        onLocationDeleteClick(locationName1);
        return;
    }
};
// Получение одного элемента списка добавленных локаций
const getLocationItem = (locationName)=>{
    const locationItemElement = (0, _templatesJs.locationItemTemplate).cloneNode(true);
    setElement({
...
const getLocationsItemsFragment = ()=>{
    ...
    const locationsList = (0, _addedLocationsJs.getLocationsList)();
    if (locationsList && locationsList.length > 0) locationsList.forEach((location)=>{
...
const renderDetailsBlock = ({ name , temperature , feelsLike , description , sunrise , sunset  })=>{
    const wrapperElement = (0, _templatesJs.blockDetailsTemplate).cloneNode(true);
    setElement({
    ...
    setElement({
        ...
        textContent: (0, _utilJs.getTimeStringWithoutSeconds)(sunrise)
    });
    setElement({
        parentNode: wrapperElement,
        selector: ".details-block__sunset span",
        textContent: (0, _utilJs.getTimeStringWithoutSeconds)(sunset)
    });
...
const onAddButtonClick = (name)=>function() {
        ...
        if (!buttonElement.classList.contains(ADD_LOCATION_ACTIVE_BUTTON_CLASS_NAME)) {
            ...
            (0, _addedLocationsJs.addLocation)(name);
        } else {
            removeActiveClassFromAddButton(buttonElement);
            (0, _addedLocationsJs.deleteLocation)(name);
        }
        renderLocations();
    };
// Рендер вкладки NOW
const renderNowBlock = ({ temperature , name , iconSource , description  })=>{
    ...
    if (oldTitleElement && oldTitleElement.textContent === name) return;
    const wrapperElement = (0, _templatesJs.blockNowTemplate).cloneNode(true);
    setElement({
        parentNode: wrapperElement,
    ...
    if ((0, _addedLocationsJs.findLocation)(name)) setActiveClassToAddButton(addButtonElement);
    addButtonElement.addEventListener("click", onAddButtonClick(name));
    blockNowElement.querySelector(".now-block__wrapper").replaceWith(wrapperElement);
};
// Действия при успешном получении данных с сервера
const onSuccessGetData = (data)=>{
    try {
        const locationData = (0, _getDataJs.getLocationData)(data);
        const locationName = (0, _getDataJs.getLocationName)(data);
        ...
        else readError = new (0, _errorJs.ReadError)((0, _errorJs.ErrorList).UNKNOWN_ERROR, error);
        (0, _errorJs.showError)(readError.message);
    }
};
...
const onSearchFormSubmit = (e)=>{
    ...
    if (cityName.trim() !== "") {
        (0, _getDataJs.getData)((0, _getDataJs.SERVICE).WEATHER, onSuccessGetData, (0, _errorJs.showError), cityName);
        (0, _getDataJs.getData)((0, _getDataJs.SERVICE).FORECAST, (0, _forecastJs.onSuccessGetForecast), (0, _errorJs.showError), cityName);
        e.target.reset();
    }
};
...
const initialRender = ()=>{
    ...
    if (currentLocationName) {
        ...
        (0, _getDataJs.getData)((0, _getDataJs.SERVICE).FORECAST, (0, _forecastJs.onSuccessGetForecast), (0, _errorJs.showError), currentLocationName);
    }
};
...
parcelHelpers.export(exports, "getTimeStringWithoutSeconds", ()=>getTimeStringWithoutSeconds);
parcelHelpers.export(exports, "getDateString", ()=>getDateString);
...
const getTimeStringWithoutSeconds = (seconds)=>(0, _dateFns.format)(getDateFromSeconds(seconds), TIME_PATTERN);
const getDateString = (seconds)=>(0, _dateFns.format)(getDateFromSeconds(seconds), DATE_PATTERN);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3zzk0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const storage = {
    saveFavouriteLocations (favouriteLocations) {
        favouriteLocations = favouriteLocations && favouriteLocations.length > 0 ? favouriteLocations : [];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jReL4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onSuccessGetForecast", ()=>onSuccessGetForecast);
var _templatesJs = require("./templates.js");
var _renderJs = require("./render.js");
var _getDataJs = require("./get-data.js");
var _utilJs = require("./util.js");
...
const getForecastItemCard = (forecastDataItem)=>{
    const forecastItemElement = (0, _templatesJs.forecastItemTemplate).cloneNode(true);
    const locationDataItem = new (0, _getDataJs.Location)(forecastDataItem);
    (0, _renderJs.setElement)({
        parentNode: forecastItemElement,
        selector: ".forecast-block__date",
        textContent: (0, _utilJs.getDateString)(locationDataItem.date)
    });
    (0, _renderJs.setElement)({
        parentNode: forecastItemElement,
        selector: ".forecast-block__time",
        textContent: (0, _utilJs.getTimeStringWithoutSeconds)(locationDataItem.date)
    });
    (0, _renderJs.setElement)({
        parentNode: forecastItemElement,
...
},{"./templates.js":"hBA0A","./render.js":"9k0mC","./get-data.js":"i3vRI","./util.js":"jQrIY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hBA0A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "blockNowTemplate", ()=>blockNowTemplate);
parcelHelpers.export(exports, "locationItemTemplate", ()=>locationItemTemplate);
parcelHelpers.export(exports, "blockDetailsTemplate", ()=>blockDetailsTemplate);
parcelHelpers.export(exports, "forecastItemTemplate", ()=>forecastItemTemplate);
const blockNowTemplate = document.getElementById("now-block").content.querySelector(".now-block__wrapper");
const blockDetailsTemplate = document.getElementById("details-block").content.querySelector(".details-block__wrapper");
const locationItemTemplate = document.getElementById("locations-item").content.querySelector(".weather__locations-item");
const forecastItemTemplate = document.getElementById("forecast-item").content.querySelector(".forecast-block__card");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i3vRI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getData", ()=>getData);
parcelHelpers.export(exports, "getLocationName", ()=>getLocationName);
...
var _errorJs = require("./error.js");
const SERVER_URL = "//api.openweathermap.org/data/2.5/";
const SERVICE = {
    WEATHER: "weather",
    FORECAST: "forecast"
};
...
const getLocationData = (data)=>{
    ...
    if (!location.name) throw new (0, _errorJs.GetDataError)("name");
    if (location.temperature === "") throw new (0, _errorJs.GetDataError)("temperature");
    if (location.feelsLike === "") throw new (0, _errorJs.GetDataError)("feelsLike");
    if (!location.description) throw new (0, _errorJs.GetDataError)("description");
    if (!location.sunrise) throw new (0, _errorJs.GetDataError)("sunrise");
    if (!location.sunset) throw new (0, _errorJs.GetDataError)("sunset");
    if (!location.iconSource) throw new (0, _errorJs.GetDataError)("iconSource");
    return location;
};
const getLocationName = (data)=>data.name;
const checkResponse = (response, service)=>{
    if (!response.ok) throw new (0, _errorJs.ConnectionError)(response.status, response.ok, service);
};
const getData = async (service, onSuccess, onFail, cityName = "", intervalsCount = 24)=>{
    try {
        ...
        let readError;
        if (error instanceof (0, _errorJs.ConnectionError)) readError = new (0, _errorJs.ReadError)((0, _errorJs.ErrorList).CONNECTION_DATA_ERROR, error);
        else readError = new (0, _errorJs.ReadError)((0, _errorJs.ErrorList).UNKNOWN_ERROR, error);
        onFail(readError.message);
    }
};

},{"./error.js":"9ndDx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ndDx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showError", ()=>showError);
parcelHelpers.export(exports, "ErrorList", ()=>ErrorList);
parcelHelpers.export(exports, "ReadError", ()=>ReadError);
parcelHelpers.export(exports, "ConnectionError", ()=>ConnectionError);
parcelHelpers.export(exports, "GetDataError", ()=>GetDataError);
const ErrorList = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aFzEi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addLocation", ()=>addLocation);
parcelHelpers.export(exports, "deleteLocation", ()=>deleteLocation);
parcelHelpers.export(exports, "getLocationsList", ()=>getLocationsList);
parcelHelpers.export(exports, "findLocation", ()=>findLocation);
var _localStorageJs = require("./local-storage.js");
...
const deleteLocation = (name)=>{
    ...
    (0, _localStorageJs.storage).saveFavouriteLocations([
        ...locationsSet
    ]);
};
...
const LOCATION_MAX_AGE = new Date(new Date().getTime() + 3600000);
const getCurrentLocationFromCookie = ()=>(0, _jsCookieDefault.default).get(CURRENT_LOCATION_COOKIE_NAME);
const setCurrentLocationToCookie = (locationName)=>(0, _jsCookieDefault.default).set(CURRENT_LOCATION_COOKIE_NAME, locationName, {
        "expires": LOCATION_MAX_AGE,
        samesite: "lax"
    });
...
},{}]},["3Unyy","bDbGG"], "bDbGG", "parcelRequire8fb7")
