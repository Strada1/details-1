...
var _showMessageJs = require("../modules/showMessage/showMessage.js");
var _localStoregeJs = require("../modules/localStorege/localStorege.js");
var _renderJs = require("../modules/render/render.js");
var _tabsJs = require("../modules/tabs/tabs.js");
...
const handlerAddInCityList = (e)=>{
    try {
        ...
        (0, _renderJs.addCityListToStorege)(currentCity);
        (0, _renderJs.renderCityList)();
    } catch (error) {
        (0, _showMessageJs.popupMessage)(error.message, error.name);
        console.error(error);
    }
};
const handlerCityesList = (e)=>{
    if (e.target.classList.contains("item__delete-cyty-btn")) {
        ...
        (0, _renderJs.deleteCityFromStorege)(deleteCity);
        (0, _renderJs.renderCityList)();
    } else if (e.target.classList.contains("item__show-cyty-btn")) try {
        getDataWeather(e.target.textContent).then((result)=>{
            const { name: nameCity , main: { feels_like , temp  } , sys: { sunrise , sunset  } , weather: [{ main: weatherMain , icon ,  }] ,  } = result;
            (0, _localStoregeJs.STOREGE).setLastSelectedСity(e.target.textContent);
            (0, _renderJs.increaseCityPriority)(e.target.textContent);
            (0, _renderJs.renderCityList)();
            (0, _renderJs.render)(nameCity, temp, feels_like, weatherMain, icon, sunrise, sunset);
        }).catch((error)=>{
            (0, _showMessageJs.popupMessage)(error.message, error.name);
            console.error(error);
        });
...
const handlerApp = (e)=>{
    e.preventDefault();
    const city = searchInput.value ? searchInput.value : (0, _localStoregeJs.STOREGE).getLastSelectedСity();
    try {
        if (!isInputValid(city)) throw new Error(`Название города не определено. Попробуйте заново!`);
        getDataWeather(city).then((result)=>{
            const { name: nameCity , main: { feels_like , temp  } , sys: { sunrise , sunset  } , weather: [{ main: weatherMain , icon ,  }] ,  } = result;
            (0, _localStoregeJs.STOREGE).setLastSelectedСity(city);
            (0, _renderJs.render)(nameCity, temp, feels_like, weatherMain, icon, sunrise, sunset);
            (0, _renderJs.renderCityList)();
        }).catch((error)=>{
            (0, _showMessageJs.popupMessage)(error.message, error.name);
...
(0, _renderJs.locationsList).addEventListener("click", handlerCityesList);
searchLocationForm.addEventListener("submit", handlerApp);

},{"../modules/showMessage/showMessage.js":"e6Is1","../modules/localStorege/localStorege.js":"a0uM7","../modules/render/render.js":"hHFtB","../modules/tabs/tabs.js":"hdacV","date-fns":"9yHCA"}],"e6Is1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "popupMessage", ()=>popupMessage);
...
function popupMessage(message, titlePopup = null) {
    try {
        if (titlePopup) popupTitle.textContent = titlePopup;
...
},{}],"a0uM7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const STOREGE = {
    ...
    pullLocalStoregeArr (decodeArray = false) {
        if (decodeArray) return JSON.parse(localStorage.getItem(this.STORAGE_KEY));
    ...
    getLastSelectedСity () {
        if (localStorage.getItem(this.STORAGE_KEY)) return JSON.parse(localStorage.getItem(this.SELECTED_CITY_KEY));
        else // здесь можно определить геолокацию и передать горрод пользователя )
        return "Киев";
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hHFtB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "renderCityList", ()=>renderCityList);
parcelHelpers.export(exports, "addCityListToStorege", ()=>addCityListToStorege);
parcelHelpers.export(exports, "deleteCityFromStorege", ()=>deleteCityFromStorege);
parcelHelpers.export(exports, "locationsList", ()=>locationsList);
parcelHelpers.export(exports, "increaseCityPriority", ()=>increaseCityPriority);
var _createDomJs = require("../view/createDom.js");
var _localStoregeJs = require("../localStorege/localStorege.js");
...
const deleteCityFromStorege = (deleteCity)=>{
    const cityArr = (0, _localStoregeJs.STOREGE).pullLocalStoregeArr(true);
    const resultArr = cityArr.filter((item)=>item.name !== deleteCity);
    (0, _localStoregeJs.STOREGE).pushLocalStoregeArr(resultArr);
};
const increaseCityPriority = (cityName)=>{
    const cityArr = (0, _localStoregeJs.STOREGE).pullLocalStoregeArr(true).map((item)=>{
        if (item.name === cityName) ++item.elementWeight;
        return item;
    });
    (0, _localStoregeJs.STOREGE).pushLocalStoregeArr(cityArr);
};
...
const isValideCity = (cityName, cityList)=>{
    ...
    if (checkValid) throw new Error("Данный город уже в списке!");
};
const addCityListToStorege = (currentCity)=>{
    let cityArr = (0, _localStoregeJs.STOREGE).pullLocalStoregeArr(true);
    if (cityArr && cityArr.length) isValideCity(currentCity, cityArr);
    else cityArr = [];
    cityArr.push({
        name: currentCity,
        elementWeight: 1
...
const addSityToDomList = (city, list)=>{
    ...
    const deleteCytyBtn = (0, _createDomJs.createElement)("button", "item__delete-cyty-btn", null, "data-delete-city", city.name);
    const showCityBtn = (0, _createDomJs.createElement)("button", "item__show-cyty-btn", currentCity);
    const element = (0, _createDomJs.createElement)("div", [
...
const renderCityList = ()=>{
    let cityArr = (0, _localStoregeJs.STOREGE).pullLocalStoregeArr() ? (0, _localStoregeJs.STOREGE).pullLocalStoregeArr(true) : [];
...
},{"../view/createDom.js":"gYnEP","../localStorege/localStorege.js":"a0uM7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gYnEP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createElement", ()=>createElement);
const createElement = (teg, classForTeg = null, valueTeg = null, atributeTeg = null, atributeValue = null)=>{
    const element = document.createElement(teg);
    if (classForTeg && !Array.isArray(classForTeg)) element.classList.add(classForTeg);
    else if (Array.isArray(classForTeg)) classForTeg.forEach((currentClass)=>{
        element.classList.add(currentClass);
    });
    valueTeg && (element.textContent = valueTeg);
    atributeTeg && element.setAttribute(atributeTeg, atributeValue);
    return element;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hdacV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2Rsls","4pp4s"], "4pp4s", "parcelRequireeebb")
