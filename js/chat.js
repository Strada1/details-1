import { SETTINGS, AUTHORIZATION, CONFIRMATION, MESSAGES, ELEMENTS, SCROLL_RENDER_VALUES, HISTORY_RENDER_VALUES, COLOR_MESSAGE, URL_STRADA, } from "./const";
...
const socket = new WebSocket(`wss://edu.strada.one/websockets?${ELEMENTS.CODE}`);
