...
var _closeSvg = require("../images/close.svg");
...
function createTabOne(nameOfCity, degrees, iconWeather) {
    ...
    if (parentImages.length) parentImages.forEach((item)=>item.remove());
    ParentImagesCurrentWeather.append(imagesIcon);
    weatherWidgetsDegrees.innerHTML = `${Math.round(degrees)}&deg;`;
}
function createTabTwo(feelsLikeValue, degrees, weatherValue, sunsetValue, sunriseValue) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dbUtr":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("3ninf") + "close.6ee707d1.svg" + "?" + Date.now();
...
},{}]},["2Rsls","4pp4s"], "4pp4s", "parcelRequire0d85")
