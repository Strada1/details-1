...
})({"itx18":[function(require,module,exports) {
"use strict";
...
var _getWeatherPromise = require("./getWeatherPromise");
var _renderDetails = require("./renderDetails");
var _customError = require("./customError");
var _customErrorDefault = parcelHelpers.interopDefault(_customError);
var _likePng = require("../img/like.png");
var _likePngDefault = parcelHelpers.interopDefault(_likePng);
var _removePng = require("../img/remove.png");
...
function likeLocation() {
    try {
        const list = new Set((0, _localstorage.getFavoriteCities)());
        const likeCity = document.querySelector(".city-name");
        list.forEach((item)=>{
            if (likeCity.textContent === item.cityName) throw new (0, _customErrorDefault.default)(`${likeCity.textContent}  уже существует в избранных `);
        });
        const favoriteCities = new AddFavoriteCities(likeCity.textContent);
        list.add(favoriteCities);
        (0, _localstorage.saveFavoriteCities)(list);
        renderLikeList();
    } catch (error) {
...
function renderNow(inputCity) {
    ...
    inputCity.then((data)=>{
        ...
        spanNowDate.textContent = `${(0, _dateFns.format)(new Date(), "h:mm")}`;
        ...
        likeImg.src = (0, _likePngDefault.default);
...
(0, _uielements.UIELEMENTS).form_input.addEventListener("submit", (event)=>{
    event.preventDefault();
    const inputCity = (0, _getWeatherPromise.getWeatherPromise)((0, _uielements.UIELEMENTS).cityName.value.split(" ").join(""));
    const divRemove = document.querySelector("#divRemove");
...
function renderLikeList() {
    ...
    const list = (0, _localstorage.getFavoriteCities)();
    locations.innerHTML = "";
    list.forEach((el)=>{
        ...
        remove.src = (0, _removePngDefault.default);
        ...
        remove.addEventListener("click", ()=>{
            ...
            (0, _localstorage.saveFavoriteCities)(newList);
            renderLikeList();
        });
...
},{"date-fns":"9yHCA","./uielements":"15zUb","./localstorage":"482oC","./getWeatherPromise":"jLWjA","./renderDetails":"eY3XV","./customError":"28NMD","../img/like.png":"5QbjG","../img/remove.png":"eOuTC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"15zUb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jLWjA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getWeatherPromise", ()=>getWeatherPromise);
async function getWeatherPromise(cityName) {
    try {
        ...
        if (!RESPONSE.ok) throw new Error("Проверьте название города");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eY3XV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderDetails", ()=>renderDetails);
var _dateFns = require("date-fns");
function renderDetails(inputCity) {
    inputCity.then((data)=>{
        ...
        SUNRISE.textContent = `Sunrise: ${(0, _dateFns.format)(new Date(data.sys.sunrise * 1000), "h:mm aa")}`;
        const SUNSET = document.querySelector("#sunset");
        SUNSET.textContent = `Sunrise: ${(0, _dateFns.format)(new Date(data.sys.sunset * 1000), "h:mm aa")}`;
    });
}

},{"date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"28NMD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5QbjG":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2ZycO") + "like.4f4cc6cd.png" + "?" + Date.now();
...
},{}],"eOuTC":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2ZycO") + "remove.a8a01576.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["itx18","gLLPy"], "gLLPy", "parcelRequirea848")
