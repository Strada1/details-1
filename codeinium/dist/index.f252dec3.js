...
})({"gMxrG":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4de0361cf252dec3";
...
},{}],"11Orx":[function(require,module,exports) {
...
function dateCount() {
    ...
    function conter(timestamp) {
        ...
        if (timestamp > 86400) {
            const days1 = Math.floor(timestamp / 86400);
            timestamp = timestamp - days1 * 86400;
            const hours1 = Math.floor(timestamp / 3600);
            timestamp = timestamp - hours1 * 3600;
            return `${days1} день/дней, ${hours1} час/часов`;
        }
        if (timestamp > 86400) {
            const hours2 = Math.floor(timestamp / 3600);
            timestamp = timestamp - hours2 * 3600;
            return `${hours2} час/часов`;
        }
    }
...
},{"../compareAsc/index.js":"h01l4","../add/index.js":"h7zb2","../differenceInDays/index.js":"1mpAo","../differenceInHours/index.js":"9Vac7","../differenceInMinutes/index.js":"4Qv17","../differenceInMonths/index.js":"8lj6Z","../differenceInSeconds/index.js":"5uZgU","../differenceInYears/index.js":"2tncr","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gMxrG","11Orx"], "11Orx", "parcelRequire94c2")

//# sourceMappingURL=index.f252dec3.js.map
